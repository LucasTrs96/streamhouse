    ...
    <form action="salvar-sala.php?page=salvar-sala" method="POST" id="formCSS">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nome_sala" class="form-control" value="<?php print $row->nome_sala; ?>">
            </div>
            <div class="form-group">
                <label>Capacidade</label>
                <input type="number" name="cap_sala" class="form-control" value="<?php print $row->cap_sala; ?>">
            </div>
            <div class="form-group">
                <label>Categoria</label>
                <input type="text" name="cat_sala" class="form-control" value="<?php print $row->cat_sala; ?>">
            </div>
            <div class="form-group">
                <label>Descrição</label>
                <input type="text" name="desc_sala" class="form-control" value="<?php print $row->desc_sala; ?>">
            </div>
            <div class="form-group">
