...
<body>
    ...
    <form action="salvar-gh.php?page=salvar-gh" method="POST" id="formCSS">
        ...
        <div class="form-group">
            ...
            <input type="text" name="raz_gh" class="form-control">
        </div>

        <div class="form-group">
            <label>Endereço</label>
            <input type="text" name="end_gh" class="form-control">
        </div>

        <div class="form-group">
            <label>C.E.P.</label>
            <input type="text" name="cep_gh" class="form-control">
        </div>

        <div class="form-group">
            <label>C.N.P.J.</label>
            <input type="text" name="cnpj_gh" class="form-control">
        </div>

        <div class="form-group">
            <label>Contato</label>
            <input type="text" name="contato_gh" class="form-control">
        </div>

        <div class="form-group">
            <label>E-Mail</label>
            <input type="text" name="email_gh" class="form-control">
        </div>
