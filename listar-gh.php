...
<body>
    ...
    if ($qtd > 0) {
        ...
        while ($row = $res->fetch_object()) {
            print "<tr>";
            print "<td>" . $row->id_gh . "</td>";
            print "<td>" . $row->raz_gh . "</td>";
            print "<td>" . $row->end_gh . "</td>";
            print "<td>" . $row->cep_gh . "</td>";
            print "<td>" . $row->cnpj_gh . "</td>";
            print "<td>" . $row->contato_gh . "</td>";
            print "<td>" . $row->email_gh . "</td>";
            print "<td>
					<button class='btn btn-success' onclick=\"location.href='editar-gh.php?page=editar-gh&id_gh=" . $row->id_gh . "';\">Editar</button>
					
					<button class='btn btn-danger' onclick=\"if(confirm('Tem certeza que deseja excluir?')){location.href='salvar-gh.php?page=salvar-gh&acao=excluir&id_gh=" . $row->id_gh . "';}else{false;}\">Excluir</button>
                    </td>";
            print "</tr>";
        }
        print "</table>";
