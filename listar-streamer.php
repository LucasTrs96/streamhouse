...
<body>
    ...
    <br>
    <h1>Listar Streamer's</h1>
    <br>
    <?php

    $sqlBuscar = "SELECT s.*, g.* FROM streamer AS s
    ...
    if ($qtd > 0) {
        ...
        print "<th>ID do Streamer</th>";
        print "<th>Nome do Streamer</th>";
        print "<th>Sexo</th>";
        ...
        while ($row = $res->fetch_object()) {
            ...
            print "<td>" . $row->id_streamer . "</td>";
            print "<td>" . $row->nome_streamer . "</td>";
            print "<td>" . $row->sexo_streamer . "</td>";
            print "<td>" . $row->nasc_streamer . "</td>";
            print "<td>" . $row->cpf_streamer . "</td>";
            print "<td>" . $row->end_streamer . "</td>";
            print "<td>" . $row->email_streamer . "</td>";
            print "<td>" . $row->contato_streamer . "</td>";
            print "<td>
					<button class='btn btn-success' onclick=\"location.href='editar-streamer.php?page=editar-streamer&id_streamer=" . $row->id_streamer . "';\">Editar</button>
					
					<button class='btn btn-danger' onclick=\"if(confirm('Tem certeza que deseja excluir?')){location.href='salvar-streamer.php?page=salvar-streamer&acao=excluir&id_streamer=" . $row->id_streamer . "';}else{false;}\">Excluir</button>
                    </td>";
            print "</tr>";
        }
        print "</table>";
