...
<body>
    ...
    switch ($_REQUEST["acao"]) {
        ...
        case "cadastrar":
            $sqlInserir = "INSERT INTO gamehouse (raz_gh, end_gh, cep_gh, cnpj_gh, contato_gh, email_gh) 
            VALUES ('" . $_REQUEST["raz_gh"] . "', '" . $_REQUEST["end_gh"] . "', '" . $_REQUEST["cep_gh"] . "', 
            '" . $_REQUEST["cnpj_gh"] . "', '" . $_REQUEST["contato_gh"] . "', '" . $_REQUEST["email_gh"] . "')";
        ...
        case "editar":
            $sqlEditar = "UPDATE gamehouse 
                    SET raz_gh='" . $_REQUEST["raz_gh"] . "', 
                        end_gh='" . $_REQUEST["end_gh"] . "', 
                        cep_gh='" . $_REQUEST["cep_gh"] . "', 
                        cnpj_gh='" . $_REQUEST["cnpj_gh"] . "', 
                        contato_gh='" . $_REQUEST["contato_gh"] . "', 
                        email_gh='" . $_REQUEST["email_gh"] . "' 
                    WHERE id_gh=" . $_REQUEST["id_gh"];
        ...
        case "excluir":
            $sqlExcluir = "DELETE FROM gamehouse 
                        WHERE id_gh=" . $_REQUEST["id_gh"];
    ...
    <p><a href="listar-gh.php?page=listar-gh" class="btn btn-primary">Listar</a></p>
