...
<body>
    ...
    switch ($_REQUEST["acao"]) {
        ...
        case "cadastrar":
            $sqlInserir = "INSERT INTO sala (gamehouse_id_gh, nome_sala, cap_sala, cat_sala, desc_sala) 
            VALUES ('" . $_REQUEST["gamehouse_id_gh"] . "', '" . $_REQUEST["nome_sala"] . "', 
            '" . $_REQUEST["cap_sala"] . "', '" . $_REQUEST["cat_sala"] . "', '" . $_REQUEST["desc_sala"] . "')";
        ...
        case "editar":
            $sqlEditar = "UPDATE sala 
                    SET nome_sala='" . $_REQUEST["nome_sala"] . "', 
                        cap_sala='" . $_REQUEST["cap_sala"] . "', 
                        cat_sala='" . $_REQUEST["cat_sala"] . "', 
                        desc_sala='" . $_REQUEST["desc_sala"] . "', 
    ...
    <p><a href="listar-sala.php?page=listar-sala" class="btn btn-primary">Listar</a></p>
